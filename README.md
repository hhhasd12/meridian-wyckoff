...
> **架构说明**：v2.1 采用三层插件化架构。`src/kernel/` 为不可插拔的内核层，
...
- [x] ~~Agent 框架整合~~ — src/agents/ 等4个目录迁入 src/plugins/agent_teams/
