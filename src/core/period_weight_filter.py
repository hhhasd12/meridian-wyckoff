...
class Timeframe(Enum):
    ...
    def get_all(cls) -> list["Timeframe"]:
        """获取所有时间框架（按周期从大到小排序）"""
        return [cls.WEEKLY, cls.DAILY, cls.H4, cls.H1, cls.M15, cls.M5]
...
class PeriodWeightFilter:
    ...
    # 默认权重配置（合计100%）
    DEFAULT_WEIGHTS = {
        Timeframe.WEEKLY: 0.25,  # 25% - 战略方向
        Timeframe.DAILY: 0.20,  # 20% - 战术背景
        Timeframe.H4: 0.18,  # 18% - 中期动量
        Timeframe.H1: 0.15,  # 15% - 短期结构
        Timeframe.M15: 0.12,  # 12% - 入场时机
        Timeframe.M5: 0.10,  # 10% - 精确点位
    }
    ...
    REGIME_ADJUSTMENTS = {
        ...
        "RANGING": {
            ...
            Timeframe.DAILY: 0.9,  # -10%
            Timeframe.H4: 1.1,  # +10%
            Timeframe.H1: 1.2,  # +20%
            Timeframe.M15: 1.1,  # +10%
            Timeframe.M5: 1.0,  # 不变
        },
        "VOLATILE": {
            Timeframe.WEEKLY: 0.7,  # -30%
            Timeframe.DAILY: 0.8,  # -20%
            Timeframe.H4: 1.0,  # 不变
            Timeframe.H1: 1.1,  # +10%
