...
class TestWyckoffSMLoadUnload:
    ...
    @patch("src.core.wyckoff_state_machine.EnhancedWyckoffStateMachine")
    @patch("src.core.wyckoff_state_machine.WyckoffStateMachine")
    ...
    @patch(
        "src.core.wyckoff_state_machine.WyckoffStateMachine",
