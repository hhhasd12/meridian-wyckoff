...
def test_module_imports():
    ...
    # 4. 数据管道模块
    from src.plugins.data_pipeline.data_pipeline import DataPipeline, DataSource, Timeframe
    ...
    # 5. TR识别器模块
    from src.plugins.pattern_detection.tr_detector import TRDetector, TRStatus, TradingRange
    ...
    # 9. 可视化调试面板
    from src.visualization.heritage_panel import HeritageVisualizer
...
def test_basic_functionality():
    ...
    # 测试异常验证器的基本方法
    from src.plugins.risk_management.anomaly_validator import AnomalyValidator, AnomalyEvent
    from datetime import datetime
