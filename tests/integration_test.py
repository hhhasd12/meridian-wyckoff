...
def test_module_imports():
    ...
    # 4. 数据管道模块
    from src.core.data_pipeline import DataPipeline, DataSource, Timeframe
    ...
    # 5. TR识别器模块
    from src.core.tr_detector import TRDetector, TRStatus, TradingRange
...
def test_basic_functionality():
    ...
    # 测试异常验证器的基本方法
    from src.core.anomaly_validator import AnomalyValidator, AnomalyEvent
    from datetime import datetime
